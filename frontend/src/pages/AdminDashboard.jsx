...
function AdminDashboard() {
    ...
    useEffect(() => {
        const fetchCounts = async () => {
            try {
                // Fetch user count
                const userResponse = await fetch(`${BE_URL}/auth/fetchusercount`, {
                    headers: {
                ...
                const deliveryBoyResponse = await fetch(`${BE_URL}/auth/fetchdeliveryboycount`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
                });
                ...
                // Fetch order counts
                const orderResponse = await fetch(`${BE_URL}/auth/fetchordercount`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
                });
                ...
                // Fetch product count
                const productResponse = await fetch(`${BE_URL}/auth/fetchproductscount`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
                });

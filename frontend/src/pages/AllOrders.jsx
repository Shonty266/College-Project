...
function AllOrders() {
    ...
    const fetchUserOrders = async () => {
        ...
        try {
            const response = await fetch(`${BE_URL}/auth/orderhistory`, {
                method: 'POST',
                headers: {
    ...
    const handleTrackClick = async (orderId, orderDetails) => {
        try {
            const response = await fetch(`${BE_URL}/receivedlocation`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (!response.ok) {
                ...
                toast.error(`Failed to track order: ${errorData.message}`);
    ...
    const handleUnlockClick = async (orderId) => {
        try {
            ...
            const searchResponse = await fetch(`${BE_URL}/searchOrder`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            const scriptResponse = await fetch(`${BE_URL}/runScript`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const confirmCancelOrder = async () => {
      ...
      try {
          if (!userId) {
            ...
            const url = `${BE_URL}/auth/orderhistory/${selectedOrderId}/cancel`;

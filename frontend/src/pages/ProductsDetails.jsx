...
function ProductsDetails() {
    ...
    const fetchProducts = async () => {
        try {
            const response = await fetch(`${BE_URL}/auth/allproducts`, {
                headers: {
    ...
    const confirmDelete = async () => {
        if (productToDelete) {
            try {
                const response = await fetch(`${BE_URL}/auth/deleteproduct/${productToDelete._id}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
    ...
    const handleUpdateStatus = async (id, status) => {
        try {
            const response = await fetch(`${BE_URL}/auth/editproducts/${id}`, {
                method: 'PATCH',
                headers: {

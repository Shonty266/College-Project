...
function OrdersDetails() {
    ...
    useEffect(() => {
        ...
        const fetchOrders = async () => {
            try {
                const response = await fetch(`${BE_URL}/auth/allorders`, {
                    headers: {
    ...
    const handleStatusChange = async (orderId, newStatus) => {
        ...
        try {
            const response = await fetch(`${BE_URL}/auth/allorders/${orderId}/status`, {
                method: 'PATCH',
                headers: {
    ...
    const handleBoxStatusChange = async (orderId, newBoxStatus) => {
        ...
        try {
            const response = await fetch(`${BE_URL}/auth/allorders/${orderId}/box-status`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const handleBoxStatusChangeReceiver = async (orderId, newReceiverBoxStatus) => {
        ...
        try {
            const response = await fetch(`${BE_URL}/auth/allorders/${orderId}/receiver-box-status`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const handleAssignDeliveryBoy = async (orderId) => {
        ...
        try {
            const response = await fetch(`${BE_URL}/auth/assignorder`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
